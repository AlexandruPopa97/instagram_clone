    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'uid':
          ...
          break;
        case 'mail':
          result.mail = serializers.deserialize(value, specifiedType: const FullType(String)) as String;
          break;
        case 'username':
...
class _$AppUser extends AppUser {
  ...
  _$AppUser._({this.uid, this.mail, this.username, this.photoUrl}) : super._() {
    if (uid == null) {
      throw new BuiltValueNullFieldError('AppUser', 'uid');
    }
    if (mail == null) {
      throw new BuiltValueNullFieldError('AppUser', 'mail');
    }
    if (username == null) {
  ...
  @override
  int get hashCode {
    return $jf($jc($jc($jc($jc(0, uid.hashCode), mail.hashCode), username.hashCode), photoUrl.hashCode));
  }
...
class AppUserBuilder implements Builder<AppUser, AppUserBuilder> {
  ...
  @override
  _$AppUser build() {
    final _$result = _$v ?? new _$AppUser._(uid: uid, mail: mail, username: username, photoUrl: photoUrl);
    replace(_$result);
    return _$result;
  }
}
